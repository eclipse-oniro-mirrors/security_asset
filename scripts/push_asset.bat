...
hdc file send \\7.222.59.152\z00639827\workspace\hmos_asset\out\generic_generic_arm_64only\hisi_higeneric_newphone_standard\lib.unstripped\security\asset\libasset_sdk_rs.dylib.so ./system/lib64/
